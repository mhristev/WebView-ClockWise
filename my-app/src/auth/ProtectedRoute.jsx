...
const ProtectedRoute = ({ children, requiredRole }) => {
  const { isAuthenticated, isAuthorized, isLoading, authError, user } =
    useAuth();
          ...
          <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              ...
              {Array.isArray(requiredRole)
                ? ` Required roles: ${requiredRole.join(" or ")}`
  ...
  // If authenticated but not authorized (wrong role) - general authorization check
  if (!isAuthorized) {
    return (
      <div className="flex flex-col justify-center items-center h-screen p-4 bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
