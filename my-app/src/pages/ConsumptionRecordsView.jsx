...
import WorkSessionDetailsModal from "../components/WorkSessionDetailsModal";

const ConsumptionRecordsView = () => {
  ...
  useEffect(() => {
    if (user && user.role !== "MANAGER" && user.role !== "ADMIN") {
      setError("Access denied. This page is only accessible to managers and administrators.");
    }
  }, [user]);
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-500">You need manager or administrator privileges to access this page.</p>
        </div>
      </div>
    );
  }
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Track employee consumption for {businessUnit?.name || 'your business unit'}
                  </p>
                </div>
              </div>
...
export default ConsumptionRecordsView;